namespace GenArt.Classes
{
...

    {
        ...
        public static bool UseSimulatedAnnealing = true;
        public static double Activetemperature = 100000.0;
        public static double Activecooling = 0.001;
        public static double Activeacceptable = 0.999999999;
        ...
        public static int ActivePointsMin = 3;
        ...
        // Simulated annealing factors 



        public static double temperature = 100000.0;
        public static double cooling = 0.001;
        public static double acceptable = 0.999999999;
        ...
        private bool SimulatedChangeFlag=false;
        ...
        public string  Cooling
        {
            set
            {
                ...
                if (isDouble)
                {
                    double.TryParse(value, out cooling);
                    SimulatedChangeFlag = true;
                }
            }
        }
        ...
        public string Acceptable
        {
            set
            {
                ...
                if (isDouble)
                {
                    double.TryParse(value, out acceptable);
                    SimulatedChangeFlag = true;
                }
            }
        }
        ...
        public void Activate()
        {
            ...
            if (SimulatedChangeFlag)
            {
                // protseduur Mona Lisa uuesti alustamiseks, sest simulated annealing peab algusest peale käima
                Activetemperature = getTemperature;
                Activecooling = getCooling;
                Activeacceptable = getAcceptable;
                SimulatedChangeFlag = false;
            }
        ...
        public void Discard()
        {
            ...
            Temperature = Activetemperature.ToString();
            Cooling = Activecooling.ToString();
            Acceptable = Activecooling.ToString();
            SimulatedChangeFlag = false;
        ...
        public void Reset()
        {
            ...
            Activetemperature = 100000.0;
            Activecooling = 0.001;
            Activeacceptable = 0.999999999;
